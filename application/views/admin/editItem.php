<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="row">
                <h3>Edit item for <?=$product['name']?></h3>
                <hr/>
                <?=form_open_multipart('Admin/doAddProduct')?>
                <div class="col-md-6">
                    <h4>Product Details</h4>
                    <input type="text" class="form-control" name="prodName" value="<?=$product['name']?>" required="required" style="margin-bottom: 0.8em;" placeholder="Enter product name here"/>
                    <textarea class="form-control" name="prodDesc" maxlength="150" required="required" style="margin-bottom: 0.8em;" placeholder="Enter product description here. Maximum of 150 characters"><?=$product['description']?></textarea>
                    <input type="number" class="form-control" name="prodQty" value="<?=$product['qty']?>" required="required" style="margin-bottom: 0.8em;" placeholder="Enter product quantity here"/>
                    <input type="number" class="form-control" name="prodPrice" value="<?=$product['price']?>" required="required" style="margin-bottom: 0.8em;" placeholder="Enter product price here (each)"/>
<!--                    <div class="well">-->
<!--                        --><?php
